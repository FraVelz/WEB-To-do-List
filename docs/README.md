...
1. **Primeros pasos** — requisitos, instalación y scripts.
2. **Arquitectura** — rutas, capas y contextos de React.
3. **Desarrollo** — calidad de código, formato y solución de problemas.
4. **Sistema de diseño** — tokens CSS y Tailwind v4.

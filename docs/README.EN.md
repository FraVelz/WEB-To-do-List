...
1. **Getting started** — requirements, install, and scripts.
2. **Architecture** — routes, layers, and React contexts.
3. **Development** — code quality, formatting, and troubleshooting.
4. **Design system** — CSS tokens and Tailwind v4.

---

[Índice en español](README.md)

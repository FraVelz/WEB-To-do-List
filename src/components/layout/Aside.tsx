...
export default function Aside({ className,  useAsideBar }: { className: string, useAsideBar: any }) {
  ...
  if (isAsideBarOpen) {
    return (
          ...
          <div>
            ...
            <div className="p-3 mb-3 flex justify-between">
              ...
              <div className="flex gap-1">
                ...
                <button className="hover:bg-hover-primary py-1 px-2 rounded-md" onClick={click_button_asidebar}>
          ...
          <div className="absolute bottom-0 left-0 w-full h-10 bg-background-sidebar px-3">
            <Pages text="Ayuda y Recursos" link="/add-task" fontsize="text-md">
              <Image src="/aside-bar/AddPlus.svg" width={24} height={24} alt="Down Arrow" />
            </Pages>
          </div>
        </aside>
